...
(
    ...
    `warehouse_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '仓库',
    `admin_id`     int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建人',
    `num`          int(10) NOT NULL COMMENT '数量',
    `type`         tinyint(1) unsigned DEFAULT '1' COMMENT '盘点类型:1=盈余,2=亏损',
    `unit_info`    text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '商品规格',
...
DROP TABLE IF EXISTS `fa_stock_bill_extend`;
CREATE TABLE `fa_stock_bill_extend`
(
    `id`               int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `stock_bill_id`    int(10) unsigned NOT NULL COMMENT '账单号',
    `out_warehouse_id` int(10) unsigned NOT NULL COMMENT '调出仓库',
    `in_warehouse_id`  int(10) unsigned NOT NULL COMMENT '调入仓库',
    `goods_id`         int(10) unsigned NOT NULL COMMENT '商品',
    `unit_info`        text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '商品规格',
    `num`              int(10) unsigned NOT NULL COMMENT '数量',
    `createtime`       int(10) NOT NULL COMMENT '创建时间',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='库存操作扩展表';

DROP TABLE IF EXISTS `fa_stock_bill`;
CREATE TABLE `fa_stock_bill`
(
    `id`         int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `bill_num`   varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '账单编号',
    `admin_id`   int(11) unsigned NOT NULL COMMENT '开单人',
    `createtime` int(11) unsigned DEFAULT NULL COMMENT '创建时间',
    `deletetime` int(11) unsigned DEFAULT NULL COMMENT '删除时间',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='库存操作表';

DROP TABLE IF EXISTS `fa_bill_extend`;
CREATE TABLE `fa_bill_extend`
(
    `id`           int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `bill_id`      int(10) unsigned NOT NULL COMMENT '账单号',
    `goods_id`     int(10) unsigned NOT NULL COMMENT '商品',
    `warehouse_id` int(10) unsigned NOT NULL COMMENT '仓库',
    `unit_info`    text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '商品规格',
    `subtotal`     int(10) NOT NULL DEFAULT '0' COMMENT '金额小计',
    `num`          int(10) unsigned NOT NULL COMMENT '数量',
    `createtime`   int(10) NOT NULL COMMENT '创建时间',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='账单详情表';

DROP TABLE IF EXISTS `fa_bill`;
CREATE TABLE `fa_bill`
(
    `id`          int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `bill_num`    varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '账单编号',
    `admin_id`    int(10) UNSIGNED NOT NULL COMMENT '开单人',
    `merchant_id` int(10) UNSIGNED NOT NULL COMMENT '商户',
    `remarks`     varchar(255) NULL DEFAULT '' COMMENT '备注',
    `type`        tinyint(1) UNSIGNED NULL COMMENT '单据类型:1=购货,2=销货',
    `createtime`  int(10) NULL COMMENT '创建时间',
    `deletetime`  int(10) NULL COMMENT '删除时间',
    `total_price` int(10) NOT NULL DEFAULT 0.00 COMMENT '总金额',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB COMMENT = '账单表';

DROP TABLE IF EXISTS `fa_goods_merchant`;
CREATE TABLE `fa_goods_merchant`
(
    `id`          int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `goods_id`    int(10) unsigned NOT NULL COMMENT '商品',
    `merchant_id` int(10) unsigned NOT NULL COMMENT '商户',
    `unit_info`   text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '单位售价',
    `type`        tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '关系类型：1-购入；2-销出；',
    `createtime`  int(10) DEFAULT NULL COMMENT '创建时间',
    `updatetime`  int(10) DEFAULT NULL COMMENT '更新时间',
    `deletetime`  int(10) unsigned DEFAULT NULL COMMENT '删除时间',
    PRIMARY KEY (`id`)
) ENGINE=InnoDB COMMENT='商户商品售价表';

DROP TABLE IF EXISTS `fa_goods_stock`;
CREATE TABLE `fa_goods_stock`
(
    `id`           int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `goods_id`     int(10) UNSIGNED NOT NULL COMMENT '商品',
    `warehouse_id` int(10) UNSIGNED NOT NULL COMMENT '所在仓库',
    `unit_info`    text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '商品规格',
    `stock`        int(10) unsigned NOT NULL DEFAULT 0 COMMENT '现有库存',
    `warning`      int(10) NOT NULL DEFAULT 0 COMMENT '预警库存',
    `createtime`   int(10) NULL COMMENT '创建时间',
...
(
    ...
    `category_id` int(10) NOT NULL COMMENT '商品类别',
    `unit_info`   text COLLATE utf8mb4_unicode_ci COMMENT '商品规格',
    `createtime`  int(10) NULL DEFAULT NULL COMMENT '创建时间',
    `updatetime`  int(10) NULL DEFAULT NULL COMMENT '更新时间',
    `deletetime`  int(10) NULL DEFAULT NULL COMMENT '删除时间',
    `admin_id`    int(10) UNSIGNED NOT NULL COMMENT '创建人',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB COMMENT = '商品表';

-- ----------------------------
-- Table structure for fa_warehouse
-- ----------------------------
DROP TABLE IF EXISTS `fa_warehouse`;
CREATE TABLE `fa_warehouse`
(
    `id`         int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
(
    `id`          int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `name`        varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '商户名称',
    `category_id` int(10) unsigned DEFAULT NULL COMMENT '商户类别',
    `contact`     varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '联系人',
    `mobile`      varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '手机号',
